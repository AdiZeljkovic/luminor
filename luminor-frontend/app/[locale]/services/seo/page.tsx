...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    const canonicalPath = locale === 'en' ? 'services/seo' : locale + '/services/seo';
    return {
        title: t('title'),
        ...
        alternates: { canonical: 'https://www.luminor.solutions/' + canonicalPath, languages: { 'en': 'https://www.luminor.solutions/services/seo', 'bs': 'https://www.luminor.solutions/bs/services/seo', 'x-default': 'https://www.luminor.solutions/services/seo' } },
    };
}


export default function SEOPage() {
    const t = useTranslations("services.seoPage");

    const detailedServicesKeys = ['onpage', 'offpage', 'technical', 'local'];
    const featuresKeys = ['technical', 'content', 'authority'];
    const processKeys = ['audit', 'optimization', 'content', 'reporting'];
