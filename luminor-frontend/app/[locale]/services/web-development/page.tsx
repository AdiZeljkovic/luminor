...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
    ...
    const canonicalPath = locale === 'en' ? 'services/web-development' : `${locale}/services/web-development`;
    return {
        title: t('title'),
        ...
        alternates: { canonical: `https://www.luminor.solutions/${canonicalPath}`, languages: { 'en': 'https://www.luminor.solutions/services/web-development', 'bs': 'https://www.luminor.solutions/bs/services/web-development', 'x-default': 'https://www.luminor.solutions/services/web-development' } },
    };
}
